...
<div class='your_talk' style="padding:20px 10px 20px 0px;">
    <jsp:include page="/kul_answer.jsp?laberId=${labelId}"/>
</div>
    ...
    <c:if test="${labelAnwsers!=null}">
        <c:forEach var="item" items="${labelAnwsers}" varStatus="i">
            <div class='talk_item'>
                ...
                <div class='talk_body'>
                    <div class='talk_head'>
                        <a href='PersonInfomation.jsp?userId=${answerUsers[i.index].userId}'>${answerUsers[i.index].name}</a>&nbsp;&nbsp;&nbsp;回复于:${item.answerDate}
                    </div>
