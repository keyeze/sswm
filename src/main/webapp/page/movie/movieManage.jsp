...
<head>
    ...
    --%>
    <script type="text/javascript" src="<%=request.getContextPath()%>/page/movie/js/movie.js"></script>
...
<div id="win" class="easyui-window" closed="true" style="width:500px;height:400px;padding:5px;">
    <form id="MsgInfo" method="post"
        ...
        <div>
            ...
            <label for="Content" style="display: inline-block;width: 15%;"></label>
            <input class="easyui-validatebox" type="text" name="content" id="content" style="width: 65%"></input>
            <br>
        </div>
        <div class="someshow">
...
<iframe src="" name="attach" style="display:none"></iframe>
</body>
</html>
