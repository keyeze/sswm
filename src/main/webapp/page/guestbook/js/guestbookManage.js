$(function () {
    ...
    var grid_obj = {
        ...
        columns: [[
            ...
            {field: 'msgId', title: '留言编号', width: 100},
            {field: 'msgTitle', title: '留言标题', width: 100},
            ...
            {field: 'p_createDate', title: '留言发布时间', width: 100},
            {field: 'sendor', title: '信息发布人', width: 100, hidden: true},
            {field: 'p_sendor', title: '留言发布人', width: 100},
            {field: 'status', title: '信息状态', width: 100, hidden: true},
            {field: 'p_status', title: '留言状态', width: 100},
